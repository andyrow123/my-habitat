...
package io.my.habitat.microservice.account.rxjava;
 ...
 *
 * <p/>
 * NOTE: This class has been automatically generated from the {@link io.my.habitat.microservice.account.AccountService original} non RX-ified interface using Vert.x codegen.
 */

@io.vertx.lang.rxjava.RxGen(io.my.habitat.microservice.account.AccountService.class)
public class AccountService {

  public static final io.vertx.lang.rxjava.TypeArg<AccountService> __TYPE_ARG = new io.vertx.lang.rxjava.TypeArg<>(
    obj -> new AccountService((io.my.habitat.microservice.account.AccountService) obj),
    AccountService::getDelegate
  );

  private final io.my.habitat.microservice.account.AccountService delegate;
  
  public AccountService(io.my.habitat.microservice.account.AccountService delegate) {
    this.delegate = delegate;
  }

  public io.my.habitat.microservice.account.AccountService getDelegate() {
    return delegate;
  }
  ...
  public static AccountService newInstance(io.my.habitat.microservice.account.AccountService arg) {
