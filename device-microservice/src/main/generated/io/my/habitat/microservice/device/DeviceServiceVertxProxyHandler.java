  ...
  public void handle(Message<JsonObject> msg) {
    try {
      ...
      switch (action) {
        ...
        case "addDevice": {
          service.addDevice(json.getJsonObject("device") == null ? null : new io.my.habitat.microservice.device.Device(json.getJsonObject("device")), createHandler(msg));
          break;
        }
        case "retrieveDevice": {
          service.retrieveDevice((java.lang.String)json.getValue("deviceId"), res -> {
            if (res.failed()) {
        ...
        case "retrieveDevicePrice": {
          service.retrieveDevicePrice((java.lang.String)json.getValue("deviceId"), createHandler(msg));
          break;
        }
        case "retrieveAllDevices": {
          service.retrieveAllDevices(res -> {
            if (res.failed()) {
              if (res.cause() instanceof ServiceException) {
                msg.reply(res.cause());
              } else {
              ...
              msg.reply(new JsonArray(res.result().stream().map(Device::toJson).collect(Collectors.toList())));
            }
         });
          break;
        }
        case "retrieveDevicesByPage": {
          service.retrieveDevicesByPage(json.getValue("page") == null ? null : (json.getLong("page").intValue()), res -> {
            if (res.failed()) {
              if (res.cause() instanceof ServiceException) {
                msg.reply(res.cause());
              } else {
        ...
        case "deleteDevice": {
          service.deleteDevice((java.lang.String)json.getValue("deviceId"), createHandler(msg));
          break;
        }
        case "deleteAllDevices": {
          service.deleteAllDevices(createHandler(msg));
          break;
        }
        default: {
