 ...
 *
 * <p/>
 * NOTE: This class has been automatically generated from the {@link io.my.habitat.microservice.room.RoomCRUDService original} non RX-ified interface using Vert.x codegen.
 */

@io.vertx.lang.rxjava.RxGen(io.my.habitat.microservice.room.RoomCRUDService.class)
public class RoomCRUDService {
  ...
  public static final io.vertx.lang.rxjava.TypeArg<RoomCRUDService> __TYPE_ARG = new io.vertx.lang.rxjava.TypeArg<>(
    obj -> new RoomCRUDService((io.my.habitat.microservice.room.RoomCRUDService) obj),
    RoomCRUDService::getDelegate
  );

  private final io.my.habitat.microservice.room.RoomCRUDService delegate;
  
  public RoomCRUDService(io.my.habitat.microservice.room.RoomCRUDService delegate) {
    this.delegate = delegate;
  }

  public io.my.habitat.microservice.room.RoomCRUDService getDelegate() {
    return delegate;
  }
  ...
  public static RoomCRUDService newInstance(io.my.habitat.microservice.room.RoomCRUDService arg) {
